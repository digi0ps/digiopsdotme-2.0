...
class About extends React.Component {
	...
	render() {
		...
		<div className="portfolio">
			...
			<p className="para center">
			As my Second Semester started, my journey towards becoming a full stack developer began. Django was my preffered choice of backend coming from an Pythonic background. So I learned it with my full enthusiasm. Django was really nice, it allowed you to almost do everything in a simple manner. After a month of fidgeting with Django, I created our university's online community along with my fellow developer Jeremy.  I have described about this in great in <Link to="blog/1">this article.</Link>
			</p>
			<p className="para center">
